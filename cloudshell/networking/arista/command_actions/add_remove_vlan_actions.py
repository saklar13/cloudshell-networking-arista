...
from cloudshell.networking.arista.command_templates import add_remove_vlan as vlan_command_template
from cloudshell.networking.arista.command_templates import iface as iface_command_template
...
class AddRemoveVlanActions(object):
    ...
    def _get_l2_protocol_tunnel_cmd(self, action_map=None, error_map=None):
        return CommandTemplateExecutor(self._cli_service, vlan_command_template.L2_TUNNEL,
